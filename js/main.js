...
(function($) {
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2025/04/18 10:30:00', function(event) {
            // Calculate months approximately from total days
            var totalDays = event.offset.totalDays;
            var months = Math.floor(totalDays / 30);
            var days = totalDays % 30;
    
            var html = '' +
                '<div class="box"><div class="date">' + months + '</div> <span>Months</span> </div>' +
                '<div class="box"><div class="date">' + days + '</div> <span>Days</span> </div>' +
                '<div class="box"><div class="date">' + event.strftime('%H') + '</div> <span>Hours</span> </div>' +
                '<div class="box"><div class="date">' + event.strftime('%M') + '</div> <span>Mins</span> </div>' +
                '<div class="box"><div class="date">' + event.strftime('%S') + '</div> <span>Secs</span> </div>';
